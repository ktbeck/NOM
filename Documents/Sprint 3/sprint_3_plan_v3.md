...
### User Story 1: As a seller/buyer, I want to give or receive payments through the app so the meal and money exchange can happen.
  ...
  - Implement payment system (Stripe) to allow users to put in their bank information (6 hours)
...
### User Story 4: As a seller/buyer, I want a clean and easy to use layout for buying or selling passes.  
...
**Nicolle Ayon:**  
  ...
  User story 4: Improve user experience by making the website look better  
**Eric Rong:**  
  User story 3: Link rating system to transaction (you may only review if you buy)  
**Steve Chan:**  
...
**Kyler Beck:**  
  ...
  User story 1: Implement payment system (Stripe) to allow users to put in their bank information   
